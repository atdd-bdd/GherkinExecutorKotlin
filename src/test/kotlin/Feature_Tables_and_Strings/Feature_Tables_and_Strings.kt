...
class Feature_Tables_and_Strings{
    ...
    fun test_Scenario_Here_are_table_options(){
        ...
        val objectListList5 = listOf<List<URL>>(
           listOf<URL>(
            URL("https://kenpugh.com"),
            ),
           listOf<URL>(
            URL("https://atdd-bdd.com"),
            ),
            )
        feature_Tables_and_Strings_glue_object.Star_A_table_to_List_of_List_of_Object_with_String_Constructor(objectListList5)

        val objectList6 = listOf<ExampleClassWithBlanks>(
        ...
        feature_Tables_and_Strings_glue_object.Star_A_table_to_List_of_Object_with_Blanks_in_Name(objectList6)
        ...
        val table7 =
            ...
            | cc  | dd  |
            """.trimIndent()
        feature_Tables_and_Strings_glue_object.Star_A_table_to_String(table7)
        }
    }
